...
chown sgeadmin /media/ephemeral0

su sgeadmin <<'EOF'
cd ~
mkdir -p /media/ephemeral0/projects/cancer_ngs
ln -s /media/ephemeral0/projects
ln -s /mnt/ngs_deploy/projects/cancer_ngs/external ~/projects/cancer_ngs/external

echo "export PATH=~/projects/cancer_ngs/external/tools/opt:~/projects/cancer_ngs/external/tools/bin:~/projects/cancer_ngs/external/bcbio-nextgen/anaconda/bin:/opt/sge6/bin/linux-x64:$PATH" >> ~/.bashrc
